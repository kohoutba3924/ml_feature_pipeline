# src/ml_feature_pipeline/normalization/raw_to_norm_lcdv2_hourly.py
...
from ml_feature_pipeline.metadata_reference.lcdv2_variables import (
...
def _iter_lcdv2_raw_files(years: Iterable[int]) -> Iterable[tuple[int, Path]]:
    base_dir = settings.RAW_DATA_DIR / "lcdv2" / "hourly"
