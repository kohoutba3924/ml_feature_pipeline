# src/comfort_index_pipeline/normalization/raw_to_norm_acs_5yr.py
...
def _get_normalized_output_path() -> Path:
    year = settings.ACS_YEAR
    return settings.NORMALIZED_DATA_DIR / f"acs5_{year}.parquet"
...
def normalize_acs_5yr() -> dict:
    ...
    output_path = _get_normalized_output_path()
